        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
               ...
               <form method="POST" action="{{route('register')}}" class="needs-validation" novalidate="">
                ...
                @endif
                  ...
                  <div class="form-group d-flex justify-content-between align-content-center">
                    <label class="m-2" for="email">Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                ...
                <div class="form-group d-flex justify-content-between align-content-center">
                  ...
                  <div class="form-group d-block">
                   ...
                   <div class="form-group d-flex justify-content-between align-content-center">
                      <label class="m-2"  for="password" class="control-label">Confirm Password</label>
                      <input name="password_confirmation" id="password"
              ...
              Aleady have an account? <a href="{{route('login')}}">Login</a>
            </div>
                  </div>
